...
- milestone: [1.17.0](https://github.com/AlphabaseOfficial/alpha-AGI)
...
- Managed Deployments **Auto-Configuration**: simplify the UI mdoels setup with backend-set models. [#436](https://github.com/AlphabaseOfficial/alpha-AGI/issues/436)
...
- [Release notes](https://github.com/AlphabaseOfficial/alpha-AGI/releases/tag/v1.14.0), and changes [v1.13.1...v1.14.0](https://github.com/AlphabaseOfficial/alpha-AGI/compare/v1.13.1...v1.14.0) (233 commits, 8,000+ lines changed)
...
- **DALL·E 3 integration** for enhanced image generation. [#212](https://github.com/AlphabaseOfficial/alpha-AGI/issues/212)
- **Perfect scrolling mechanics** across devices. [#304](https://github.com/AlphabaseOfficial/alpha-AGI/issues/304)
- Persona creation now supports **text input**. [#287](https://github.com/AlphabaseOfficial/alpha-AGI/pull/287)
...
- **Google Gemini Support**: Use the newest Google models. [#275](https://github.com/enricoros/alpha-agi/issues/275)
- **Mistral Platform**: Mixtral and future models support. [#273](https://github.com/enricoros/alpha-agi/issues/273)
- **Diagram Instructions**. Thanks to @joriskalz! [#280](https://github.com/enricoros/alpha-agi/pull/280)
- Ollama Chats: Enhanced chatting experience. [#270](https://github.com/enricoros/alpha-agi/issues/270)
- Mac Shortcuts Fix: Improved UX on Mac
- **Single-Tab Mode**: Data integrity with single window. [#268](https://github.com/enricoros/alpha-agi/issues/268)
- **Updated Models**: Latest Ollama (v0.1.17) and OpenRouter models
- Official Downloads: Easy access to the latest alpha-AGI on [alpha-AGI.com](https://alphabase.co)
- For developers: [troubleshot networking](https://github.com/AlphabaseOfficial/alpha-AGI/issues/276#issuecomment-1858591483), fixed Vercel deployment, cleaned up the LLMs/Streaming framework

### What's New in 1.7.0 · Dec 11, 2023 · Attachment Theory

- **Attachments System Overhaul**: Drag, paste, link, snap, text, images, PDFs and more. [#251](https://github.com/enricoros/alpha-agi/issues/251)
- **Desktop Webcam Capture**: Image capture now available as Labs feature. [#253](https://github.com/enricoros/alpha-agi/issues/253)
- **Independent Browsing**: Full browsing support with Browserless. [Learn More](https://github.com/enricoros/alpha-agi/blob/main/docs/config-feature-browse.md)
- **Overheat LLMs**: Push the creativity with higher LLM temperatures. [#256](https://github.com/enricoros/alpha-agi/issues/256)
- **Model Options Shortcut**: Quick adjust with `Ctrl+Shift+O`
- Optimized Voice Input and Performance
- Latest Ollama models
- For developers: **Password Protection**: HTTP Basic Auth. [Learn How](https://github.com/enricoros/alpha-agi/blob/main/docs/deploy-authentication.md)

### What's New in 1.6.0 - Nov 28, 2023 · Surf's Up

- **Web Browsing**: Download web pages within chats - [browsing guide](https://github.com/enricoros/alpha-agi/blob/main/docs/config-feature-browse.md)
...
- Runtime Server-Side configuration:  https://github.com/enricoros/alpha-agi/issues/189. Env vars are
  ...
  https://github.com/enricoros/alpha-agi/blob/main/src/modules/backend/backend.router.ts.
...
- Removed the 20 chats hard limit ([Ashesh3](https://github.com/enricoros/alpha-agi/pull/158))
- Latex Rendering
...
### April / May: more #alpha-agi-energy
...
- **Code Execution: Sandpack** -
  [now on branch]((https://github.com/enricoros/alpha-agi/commit/f678a0d463d5e9cf0733f577e11bd612b7902d89)) `variant-code-execution`

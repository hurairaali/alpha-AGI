...
Ensuring microphone access is essential for using voice features in applications like alpha-AGI.

## Desktop Browsers

### Google Chrome (All Platforms, recommended)

1. Open the website (e.g., alpha-AGI) in Chrome.
...
2. Click **Safari** in the top menu bar.
   ...
   - Find alpha-AGI (or localhost for developers) in the list and set it to **Allow**.
   - Close the Settings window.
3. **Refresh** the page.

This quick and simple fix should get essential voice input working in alpha-AGI on your Mac.
...
For persistent issues, consult your browser's official support resources or contact alpha-AGI support.

## Technical Details

ALPHA-AGI uses the [Web Speech API (SpeechRecognition)](https://developer.mozilla.org/en-US/docs/Web/API/SpeechRecognition)
